...
QUESTION_FILE=data/test/music-avqa-test_mm_image+audio.json
SCORE_FILE=./playground/data/eval/answers/$ANS_CKPT/MUSIC-AVQA/score_image+audio.txt
...
output_file=./playground/data/eval/answers/$ANS_CKPT/MUSIC-AVQA/merge_image+audio.jsonl
