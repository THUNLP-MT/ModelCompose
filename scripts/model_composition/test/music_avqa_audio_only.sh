...
QUESTION_FILE=data/test/music-avqa-test_mm_audio.json
SCORE_FILE=./playground/data/eval/answers/$ANS_CKPT/MUSIC-AVQA/score_audio_only.txt
...
output_file=./playground/data/eval/answers/$ANS_CKPT/MUSIC-AVQA/merge_audio_only.jsonl
