...
QUESTION_FILE=data/test/music-avqa-test_mm_image+video.json
SCORE_FILE=./playground/data/eval/answers/$ANS_CKPT/MUSIC-AVQA/score_image+video_$VERSION.txt
output_file=./playground/data/eval/answers/$ANS_CKPT/MUSIC-AVQA/merge_image+video_$VERSION.jsonl
