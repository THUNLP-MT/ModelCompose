...
QUESTION_FILE=data/test/music-avqa-test_mm_video.json
SCORE_FILE=./playground/data/eval/answers/$ANS_CKPT/MUSIC-AVQA/score_video_only.txt
...
output_file=./playground/data/eval/answers/$ANS_CKPT/MUSIC-AVQA/merge_video_only.jsonl
