...
DATA_FILE="data/train/VideoInstruct100K_multimodal_with_imagedata.json"
...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29952 modelcompose/train/train_multimodal.py \
    ...
    --version v1 \
    --data_path $DATA_FILE \
    --mm_video_encoder model/LanguageBind_Video_merge \
    --mm_video_select_layer -2 \
    --pretrain_mm_mlp_adapter model/Video-LLaVA-Pretrain-7B/multimodal_video_projector.bin \
    --mm_video_projector_type mlp2x_gelu \
    --image_aspect_ratio pad \
    --group_by_modality_length True \
    --bf16 True \
    --output_dir ./checkpoints/modelcompose-video-finetune-proj-only \
    --num_train_epochs 1 \
