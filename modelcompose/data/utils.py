...
from modelcompose.constants import MODAL_TOKENS, IGNORE_INDEX
    ...
    for conversation, target in zip(conversations, targets):
        ...
        for i, rou in enumerate(re_rounds):
            ...
            if len(parts) != 2:
                break
            parts[0] += sep
            round_len = len(tokenizer_modal_token(rou, tokenizer)) + len(tokenizer_image_token(conv.sep, tokenizer))
