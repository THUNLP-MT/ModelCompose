...
def forward(
    ...
    if modal_attention_mask is None:
        ...
        # [MODAL ATTENTION]
        attn_output, attn_output_lora = self.o_proj(output, active_adapters=(self.config.lora_name,))
...
def replace_llava_attn_with_flash_attn():
    ...
    modelcompose.model.language_model.local_llava_llama.LocalLlavaModel._prepare_decoder_attention_mask = (
        _prepare_decoder_attention_mask
    )
    modelcompose.model.language_model.local_llava_llama.LocalLlavaAttention.forward = forward
